...
{
    [LoggerMessage(LogLevel.Error, "Authenticate error: cookie {cookie}, tenant {tenant}, userid {userid}, indexTenant {indexTenant}, expire {expire}, loginEvent {loginEvent}")]
    ...
    [LoggerMessage(LogLevel.Error, "Failed to get login event ID from cookie: cookie {cookie}, loginEvent {loginEventId}")]
