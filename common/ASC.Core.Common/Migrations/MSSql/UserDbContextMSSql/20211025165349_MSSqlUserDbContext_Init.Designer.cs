...
namespace ASC.Core.Common.Migrations.MSSql.UserDbContextMSSql
{
    ...
    [Migration("20211025165349_MSSqlUserDbContext_Init")]
    partial class MSSqlUserDbContext_Init
    {
            ...
            modelBuilder.Entity("ASC.Core.Common.EF.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModified = new DateTime(2021, 10, 25, 16, 53, 48, 919, DateTimeKind.Utc).AddTicks(9368),
                            LastName = "",
                            PhoneActivation = 0,
                            Removed = false,
                            Status = 1,
                            ...
                            WorkFromDate = new DateTime(2021, 10, 25, 16, 53, 48, 919, DateTimeKind.Utc).AddTicks(8929)
                        });
                });
            ...
            modelBuilder.Entity("ASC.Core.Common.EF.UserSecurity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = new Guid("66faa6e4-f133-11ea-b126-00ffeec8b4ef"),
                            LastModified = new DateTime(2021, 10, 25, 16, 53, 48, 927, DateTimeKind.Utc).AddTicks(7256),
