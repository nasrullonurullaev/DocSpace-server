...
{
    [LoggerMessage(LogLevel.Error, "GetAdvanced")]
    ...
    [LoggerMessage(LogLevel.Error, "GetSearch")]
    public static partial void ErrorGetSearch(this ILogger<UserController> logger, Exception exception);

    [LoggerMessage(LogLevel.Debug, "ERROR write to template_unsubscribe, email:{email}")]
